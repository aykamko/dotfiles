...
class PlatformLink(dotbot.Plugin):
    '''
    Symbolically links dotfiles according to platform.
    '''

    _directive = 'platform-link'
    ...
    def handle(self, directive, data):
        ...
        return self._process_platforms(data)

    def _process_platforms(self, platforms):
        uname = os.uname()[0].lower()
        if not platforms.get(uname):
            self._log.lowinfo('No links for this platform')
            return True
        return self._process_links(platforms[uname])
